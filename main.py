...
**🔊 VOICE COMMANDS:**
{'✅ `/join` - Bot joins your voice channel' if is_whitelisted or is_owner else '❌ `/join` - Whitelist Only'}
{'✅ `/leave` - Bot leaves voice channel' if is_whitelisted or is_owner else '❌ `/leave` - Whitelist Only'}
{'✅ `/voicekick <member>` - Kick a user from voice' if is_whitelisted or is_owner else '❌ `/voicekick` - Whitelist Only'}
{'✅ `/voicemoveall <channel>` - Move ALL to a voice channel' if is_whitelisted or is_owner else '❌ `/voicemoveall` - Whitelist Only'}
{'✅ `/voicedisconnectall` - Disconnect ALL from voice' if is_whitelisted or is_owner else '❌ `/voicedisconnectall` - Whitelist Only'}
